...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Ontology', fields ['version']
        db.delete_unique(u'core_ontology', ['version'])


        # Changing field 'Ontology.version'
        db.alter_column(u'core_ontology', 'version', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Ontology.version'
        db.alter_column(u'core_ontology', 'version', self.gf('django.db.models.fields.CharField')(default='', max_length=256, unique=True))
        # Adding unique constraint on 'Ontology', fields ['version']
        db.create_unique(u'core_ontology', ['version'])
