...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ontology.version'
        db.add_column(u'core_ontology', 'version',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ontology.version'
        db.delete_column(u'core_ontology', 'version')
    ...
    models = {
        ...
        u'core.ontology': {
            ...
            'version': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256', 'blank': 'True'})
        },
        u'core.project': {
