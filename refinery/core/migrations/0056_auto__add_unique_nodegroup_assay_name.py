...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NodeGroup', fields ['assay', 'name']
        db.create_unique(u'core_nodegroup', ['assay_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'NodeGroup', fields ['assay', 'name']
        db.delete_unique(u'core_nodegroup', ['assay_id', 'name'])
