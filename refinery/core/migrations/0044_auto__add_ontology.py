...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_ontology', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('import_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('acronym', self.gf('django.db.models.fields.CharField')(unique=True, max_length=8, blank=True)),
            ('uri', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128, blank=True)),
            ('update_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'core', ['Ontology'])


    def backwards(self, orm):
        # Deleting model 'Ontology'
        db.delete_table(u'core_ontology')
    ...
    models = {
        ...
        u'core.ontology': {
            ...
            'update_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
