...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'core_externaltoolstatus')


    def backwards(self, orm):
        # Adding model 'ExternalToolStatus'
        db.create_table(u'core_externaltoolstatus', (
            ...
            ('unique_instance_identifier', self.gf('django.db.models.fields.CharField')(default=None, max_length=256, null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'core', ['ExternalToolStatus'])
