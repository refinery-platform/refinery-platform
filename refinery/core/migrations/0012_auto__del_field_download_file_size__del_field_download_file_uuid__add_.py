...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Download.file_size'
        db.delete_column('core_download', 'file_size')

        # Deleting field 'Download.file_uuid'
        db.delete_column('core_download', 'file_uuid')

        # Adding field 'Download.file_store_item'
        db.add_column('core_download', 'file_store_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['file_store.FileStoreItem']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Download.file_size'
        db.add_column('core_download', 'file_size',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Download.file_uuid'
        db.add_column('core_download', 'file_uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36),
                      keep_default=False)

        # Deleting field 'Download.file_store_item'
        db.delete_column('core_download', 'file_store_item_id')
    ...
    models = {
        ...
        'core.download': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'max_length': '5000', 'blank': 'True'}),
            'file_store_item': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['file_store.FileStoreItem']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
