...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'InvestigationLink', fields ['data_set', 'investigation', 'version']
        db.create_unique('core_investigationlink', ['data_set_id', 'investigation_id', 'version'])


    def backwards(self, orm):
        # Removing unique constraint on 'InvestigationLink', fields ['data_set', 'investigation', 'version']
        db.delete_unique('core_investigationlink', ['data_set_id', 'investigation_id', 'version'])
