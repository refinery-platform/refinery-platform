...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalysisNodeConnection.is_refinery_file'
        db.add_column('core_analysisnodeconnection', 'is_refinery_file',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'AnalysisNodeConnection.node'
        db.alter_column('core_analysisnodeconnection', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['data_set_manager.Node']))

        # Changing field 'AnalysisNodeConnection.direction'
        db.alter_column('core_analysisnodeconnection', 'direction', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):
        # Deleting field 'AnalysisNodeConnection.is_refinery_file'
        db.delete_column('core_analysisnodeconnection', 'is_refinery_file')


        # Changing field 'AnalysisNodeConnection.node'
        db.alter_column('core_analysisnodeconnection', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['data_set_manager.Node']))

        # Changing field 'AnalysisNodeConnection.direction'
        db.alter_column('core_analysisnodeconnection', 'direction', self.gf('django.db.models.fields.IntegerField')())
