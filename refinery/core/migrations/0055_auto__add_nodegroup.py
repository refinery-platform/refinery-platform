...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_nodegroup', (
            ...
            ('node_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        # Adding M2M table for field nodes_uuids on 'NodeGroup'
        m2m_table_name = db.shorten_name(u'core_nodegroup_nodes_uuids')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field nodes_uuids on 'NodeGroup'
        db.delete_table(db.shorten_name(u'core_nodegroup_nodes_uuids'))
