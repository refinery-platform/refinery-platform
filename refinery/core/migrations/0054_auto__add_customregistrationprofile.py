...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_customregistrationprofile', (
        ...
        db.send_create_signal(u'core', ['CustomRegistrationProfile'])


    def backwards(self, orm):
        # Deleting model 'CustomRegistrationProfile'
        db.delete_table(u'core_customregistrationprofile')
    ...
    models = {
        ...
        u'core.ontology': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 16, 0, 0)'}),
        ...
        u'file_store.filestoreitem': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '36', 'blank': 'True'})
        },
