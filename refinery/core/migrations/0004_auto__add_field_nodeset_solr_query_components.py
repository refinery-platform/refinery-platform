...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeSet.solr_query_components'
        db.add_column('core_nodeset', 'solr_query_components',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NodeSet.solr_query_components'
        db.delete_column('core_nodeset', 'solr_query_components')
