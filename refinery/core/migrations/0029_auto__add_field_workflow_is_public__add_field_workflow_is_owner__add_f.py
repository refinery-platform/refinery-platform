...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workflow.is_public'
        db.add_column(u'core_workflow', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Workflow.is_owner'
        db.add_column(u'core_workflow', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Workflow.owner_id'
        db.add_column(u'core_workflow', 'owner_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Workflow.owner_username'
        db.add_column(u'core_workflow', 'owner_username',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'DiskQuota.is_public'
        db.add_column(u'core_diskquota', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DiskQuota.is_owner'
        db.add_column(u'core_diskquota', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DiskQuota.owner_id'
        db.add_column(u'core_diskquota', 'owner_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'DiskQuota.owner_username'
        db.add_column(u'core_diskquota', 'owner_username',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'Download.is_public'
        db.add_column(u'core_download', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Download.is_owner'
        db.add_column(u'core_download', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Download.owner_id'
        db.add_column(u'core_download', 'owner_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Download.owner_username'
        db.add_column(u'core_download', 'owner_username',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'NodeSet.is_public'
        db.add_column(u'core_nodeset', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NodeSet.is_owner'
        db.add_column(u'core_nodeset', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NodeSet.owner_id'
        db.add_column(u'core_nodeset', 'owner_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'NodeSet.owner_username'
        db.add_column(u'core_nodeset', 'owner_username',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'Analysis.is_public'
        db.add_column(u'core_analysis', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Analysis.is_owner'
        db.add_column(u'core_analysis', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Analysis.owner_id'
        db.add_column(u'core_analysis', 'owner_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Analysis.owner_username'
        db.add_column(u'core_analysis', 'owner_username',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'Project.is_public'
        db.add_column(u'core_project', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.is_owner'
        db.add_column(u'core_project', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.owner_id'
        db.add_column(u'core_project', 'owner_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Project.owner_username'
        db.add_column(u'core_project', 'owner_username',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'WorkflowEngine.is_public'
        db.add_column(u'core_workflowengine', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WorkflowEngine.is_owner'
        db.add_column(u'core_workflowengine', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WorkflowEngine.owner_id'
        db.add_column(u'core_workflowengine', 'owner_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'WorkflowEngine.owner_username'
        db.add_column(u'core_workflowengine', 'owner_username',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'NodeRelationship.is_public'
        db.add_column(u'core_noderelationship', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataSet.is_public'
        db.add_column(u'core_dataset', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataSet.is_owner'
        db.add_column(u'core_dataset', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataSet.owner_id'
        db.add_column(u'core_dataset', 'owner_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'DataSet.owner_username'
        db.add_column(u'core_dataset', 'owner_username',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workflow.is_public'
        db.delete_column(u'core_workflow', 'is_public')

        # Deleting field 'Workflow.is_owner'
        db.delete_column(u'core_workflow', 'is_owner')

        # Deleting field 'Workflow.owner_id'
        db.delete_column(u'core_workflow', 'owner_id')

        # Deleting field 'Workflow.owner_username'
        db.delete_column(u'core_workflow', 'owner_username')

        # Deleting field 'DiskQuota.is_public'
        db.delete_column(u'core_diskquota', 'is_public')

        # Deleting field 'DiskQuota.is_owner'
        db.delete_column(u'core_diskquota', 'is_owner')

        # Deleting field 'DiskQuota.owner_id'
        db.delete_column(u'core_diskquota', 'owner_id')

        # Deleting field 'DiskQuota.owner_username'
        db.delete_column(u'core_diskquota', 'owner_username')

        # Deleting field 'Download.is_public'
        db.delete_column(u'core_download', 'is_public')

        # Deleting field 'Download.is_owner'
        db.delete_column(u'core_download', 'is_owner')

        # Deleting field 'Download.owner_id'
        db.delete_column(u'core_download', 'owner_id')

        # Deleting field 'Download.owner_username'
        db.delete_column(u'core_download', 'owner_username')

        # Deleting field 'NodeSet.is_public'
        db.delete_column(u'core_nodeset', 'is_public')

        # Deleting field 'NodeSet.is_owner'
        db.delete_column(u'core_nodeset', 'is_owner')

        # Deleting field 'NodeSet.owner_id'
        db.delete_column(u'core_nodeset', 'owner_id')

        # Deleting field 'NodeSet.owner_username'
        db.delete_column(u'core_nodeset', 'owner_username')

        # Deleting field 'Analysis.is_public'
        db.delete_column(u'core_analysis', 'is_public')

        # Deleting field 'Analysis.is_owner'
        db.delete_column(u'core_analysis', 'is_owner')

        # Deleting field 'Analysis.owner_id'
        db.delete_column(u'core_analysis', 'owner_id')

        # Deleting field 'Analysis.owner_username'
        db.delete_column(u'core_analysis', 'owner_username')

        # Deleting field 'Project.is_public'
        db.delete_column(u'core_project', 'is_public')

        # Deleting field 'Project.is_owner'
        db.delete_column(u'core_project', 'is_owner')

        # Deleting field 'Project.owner_id'
        db.delete_column(u'core_project', 'owner_id')

        # Deleting field 'Project.owner_username'
        db.delete_column(u'core_project', 'owner_username')

        # Deleting field 'WorkflowEngine.is_public'
        db.delete_column(u'core_workflowengine', 'is_public')

        # Deleting field 'WorkflowEngine.is_owner'
        db.delete_column(u'core_workflowengine', 'is_owner')

        # Deleting field 'WorkflowEngine.owner_id'
        db.delete_column(u'core_workflowengine', 'owner_id')

        # Deleting field 'WorkflowEngine.owner_username'
        db.delete_column(u'core_workflowengine', 'owner_username')

        # Deleting field 'NodeRelationship.is_public'
        db.delete_column(u'core_noderelationship', 'is_public')

        # Deleting field 'DataSet.is_public'
        db.delete_column(u'core_dataset', 'is_public')

        # Deleting field 'DataSet.is_owner'
        db.delete_column(u'core_dataset', 'is_owner')

        # Deleting field 'DataSet.owner_id'
        db.delete_column(u'core_dataset', 'owner_id')

        # Deleting field 'DataSet.owner_username'
        db.delete_column(u'core_dataset', 'owner_username')
    ...
    models = {
        ...
        u'core.analysis': {
            ...
            'owner_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
