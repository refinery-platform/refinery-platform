...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Workflow', fields ['workflow_engine', 'internal_id']
        db.delete_unique('core_workflow', ['workflow_engine_id', 'internal_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Workflow', fields ['workflow_engine', 'internal_id']
        db.create_unique('core_workflow', ['workflow_engine_id', 'internal_id'])
