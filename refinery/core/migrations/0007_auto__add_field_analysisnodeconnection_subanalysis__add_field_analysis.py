...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalysisNodeConnection.subanalysis'
        db.add_column('core_analysisnodeconnection', 'subanalysis',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'AnalysisNodeConnection.filename'
        db.add_column('core_analysisnodeconnection', 'filename',
                      self.gf('django.db.models.fields.CharField')(default='testfilename', max_length=100),
                      keep_default=False)

        # Adding unique constraint on 'AnalysisNodeConnection', fields ['subanalysis', 'name', 'analysis']
        db.create_unique('core_analysisnodeconnection', ['subanalysis', 'name', 'analysis_id'])

        # Adding unique constraint on 'AnalysisNodeConnection', fields ['subanalysis', 'analysis']
        db.create_unique('core_analysisnodeconnection', ['subanalysis', 'analysis_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AnalysisNodeConnection', fields ['subanalysis', 'analysis']
        db.delete_unique('core_analysisnodeconnection', ['subanalysis', 'analysis_id'])

        # Removing unique constraint on 'AnalysisNodeConnection', fields ['subanalysis', 'name', 'analysis']
        db.delete_unique('core_analysisnodeconnection', ['subanalysis', 'name', 'analysis_id'])

        # Deleting field 'AnalysisNodeConnection.subanalysis'
        db.delete_column('core_analysisnodeconnection', 'subanalysis')

        # Deleting field 'AnalysisNodeConnection.filename'
        db.delete_column('core_analysisnodeconnection', 'filename')
    ...
    models = {
        ...
        'core.analysisnodeconnection': {
            'Meta': {'unique_together': "(('name', 'subanalysis', 'analysis'), ('subanalysis', 'analysis'))", 'object_name': 'AnalysisNodeConnection'},
