...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Workflow.name'
        db.alter_column(u'core_workflow', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'DiskQuota.name'
        db.alter_column(u'core_diskquota', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Download.name'
        db.alter_column(u'core_download', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'NodeSet.name'
        db.alter_column(u'core_nodeset', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Analysis.name'
        db.alter_column(u'core_analysis', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Project.name'
        db.alter_column(u'core_project', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'WorkflowEngine.name'
        db.alter_column(u'core_workflowengine', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'NodeRelationship.name'
        db.alter_column(u'core_noderelationship', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'DataSet.name'
        db.alter_column(u'core_dataset', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Workflow.name'
        db.alter_column(u'core_workflow', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'DiskQuota.name'
        db.alter_column(u'core_diskquota', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'Download.name'
        db.alter_column(u'core_download', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'NodeSet.name'
        db.alter_column(u'core_nodeset', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'Analysis.name'
        db.alter_column(u'core_analysis', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'Project.name'
        db.alter_column(u'core_project', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'WorkflowEngine.name'
        db.alter_column(u'core_workflowengine', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'NodeRelationship.name'
        db.alter_column(u'core_noderelationship', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'DataSet.name'
        db.alter_column(u'core_dataset', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250))
