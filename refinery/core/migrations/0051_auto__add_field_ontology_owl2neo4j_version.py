...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ontology.owl2neo4j_version'
        db.add_column(u'core_ontology', 'owl2neo4j_version',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ontology.owl2neo4j_version'
        db.delete_column(u'core_ontology', 'owl2neo4j_version')
