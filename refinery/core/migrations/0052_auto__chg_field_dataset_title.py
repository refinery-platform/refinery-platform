...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataSet.title'
        db.alter_column(u'core_dataset', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'DataSet.title'
        db.alter_column(u'core_dataset', 'title', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
