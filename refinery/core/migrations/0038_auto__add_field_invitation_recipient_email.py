...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invitation.recipient_email'
        db.add_column(u'core_invitation', 'recipient_email',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invitation.recipient_email'
        db.delete_column(u'core_invitation', 'recipient_email')
