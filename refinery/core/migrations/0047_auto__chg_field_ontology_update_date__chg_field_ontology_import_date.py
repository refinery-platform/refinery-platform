...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_ontology', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Ontology.import_date'
        db.alter_column(u'core_ontology', 'import_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Ontology.update_date'
        db.alter_column(u'core_ontology', 'update_date', self.gf('django.db.models.fields.DateField')(auto_now=True))
