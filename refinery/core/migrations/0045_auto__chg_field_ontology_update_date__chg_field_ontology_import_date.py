...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ontology.update_date'
        db.alter_column(u'core_ontology', 'update_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Ontology.import_date'
        db.alter_column(u'core_ontology', 'import_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Ontology.update_date'
        db.alter_column(u'core_ontology', 'update_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Ontology.import_date'
        db.alter_column(u'core_ontology', 'import_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        u'core.analysis': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '250', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'core.ontology': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
