...
core_router.urls.extend([
    url(r'^data_sets/(?P<uuid>{})/$'.format(UUID_RE),
        DataSetsViewSet.as_view()),
    url(r'^analyses/(?P<uuid>{})/$'.format(UUID_RE),
