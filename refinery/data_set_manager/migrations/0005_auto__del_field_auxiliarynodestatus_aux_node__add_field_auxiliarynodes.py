...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AuxiliaryNodeStatus.aux_node'
        db.delete_column(u'data_set_manager_auxiliarynodestatus', 'aux_node_id')

        # Adding field 'AuxiliaryNodeStatus.uuid'
        db.add_column(u'data_set_manager_auxiliarynodestatus', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AuxiliaryNodeStatus.aux_node'
        db.add_column(u'data_set_manager_auxiliarynodestatus', 'aux_node',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['data_set_manager.Node']),
                      keep_default=False)

        # Deleting field 'AuxiliaryNodeStatus.uuid'
        db.delete_column(u'data_set_manager_auxiliarynodestatus', 'uuid')
    ...
    models = {
        ...
        u'data_set_manager.auxiliarynodestatus': {
            'Meta': {'object_name': 'AuxiliaryNodeStatus'},
            'aux_node_generation_task_state': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '36', 'blank': 'True'})
        },
