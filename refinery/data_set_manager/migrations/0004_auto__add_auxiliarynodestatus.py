...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_set_manager_auxiliarynodestatus', (
            ...
            ('aux_node', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data_set_manager.Node'])),
    ...
    models = {
        ...
        u'data_set_manager.auxiliarynodestatus': {
            ...
            'aux_node': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data_set_manager.Node']"}),
