...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'AuxiliaryNodeStatus'
        db.delete_table(u'data_set_manager_auxiliarynodestatus')

        # Removing index on 'AnnotatedNode', fields ['node_genome_build']
        db.delete_index(u'data_set_manager_annotatednode', ['node_genome_build'])

        # Removing index on 'AnnotatedNode', fields ['node_name']
        db.delete_index(u'data_set_manager_annotatednode', ['node_name'])

        # Removing index on 'AnnotatedNode', fields ['attribute_value']
        db.delete_index(u'data_set_manager_annotatednode', ['attribute_value'])

        # Removing index on 'AnnotatedNode', fields ['node_type']
        db.delete_index(u'data_set_manager_annotatednode', ['node_type'])

        # Removing index on 'AnnotatedNode', fields ['attribute_subtype']
        db.delete_index(u'data_set_manager_annotatednode', ['attribute_subtype'])

        # Removing index on 'AnnotatedNode', fields ['attribute_type']
        db.delete_index(u'data_set_manager_annotatednode', ['attribute_type'])

        # Removing index on 'AnnotatedNode', fields ['node_species']
        db.delete_index(u'data_set_manager_annotatednode', ['node_species'])

        # Removing index on 'AnnotatedNodeRegistry', fields ['node_type']
        db.delete_index(u'data_set_manager_annotatednoderegistry', ['node_type'])


    def backwards(self, orm):
        # Adding index on 'AnnotatedNodeRegistry', fields ['node_type']
        db.create_index(u'data_set_manager_annotatednoderegistry', ['node_type'])

        # Adding index on 'AnnotatedNode', fields ['node_species']
        db.create_index(u'data_set_manager_annotatednode', ['node_species'])

        # Adding index on 'AnnotatedNode', fields ['attribute_type']
        db.create_index(u'data_set_manager_annotatednode', ['attribute_type'])

        # Adding index on 'AnnotatedNode', fields ['attribute_subtype']
        db.create_index(u'data_set_manager_annotatednode', ['attribute_subtype'])

        # Adding index on 'AnnotatedNode', fields ['node_type']
        db.create_index(u'data_set_manager_annotatednode', ['node_type'])

        # Adding index on 'AnnotatedNode', fields ['attribute_value']
        db.create_index(u'data_set_manager_annotatednode', ['attribute_value'])

        # Adding index on 'AnnotatedNode', fields ['node_name']
        db.create_index(u'data_set_manager_annotatednode', ['node_name'])

        # Adding index on 'AnnotatedNode', fields ['node_genome_build']
        db.create_index(u'data_set_manager_annotatednode', ['node_genome_build'])

        # Adding model 'AuxiliaryNodeStatus'
        db.create_table(u'data_set_manager_auxiliarynodestatus', (
            ('aux_node_generation_task_state', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default=None, max_length=36, blank=True)),
        ))
        db.send_create_signal(u'data_set_manager', ['AuxiliaryNodeStatus'])


    models = {
        u'data_set_manager.annotatednode': {
            ...
            'attribute': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data_set_manager.Attribute']"}),
            'attribute_subtype': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'attribute_type': ('django.db.models.fields.TextField', [], {}),
            'attribute_value': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'node_genome_build': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'node_name': ('django.db.models.fields.TextField', [], {}),
            'node_species': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        u'data_set_manager.annotatednoderegistry': {
        ...
        u'data_set_manager.attributedefinition': {
        ...
        u'data_set_manager.attributeorder': {
        ...
        u'data_set_manager.contact': {
            'Meta': {'object_name': 'Contact'},
            'address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'affiliation': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data_set_manager.NodeCollection']"}),
        ...
        u'data_set_manager.node': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_annotation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_auxiliary_node': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'data_set_manager.protocol': {
            'Meta': {'ordering': "['id']", 'object_name': 'Protocol'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'data_set_manager.protocolcomponent': {
            'Meta': {'object_name': 'ProtocolComponent'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data_set_manager.Protocol']"}),
            'study': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data_set_manager.Study']"}),
            'type': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'type_accession': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'type_source': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'data_set_manager.protocolparameter': {
        ...
        u'data_set_manager.protocolreference': {
        ...
        u'data_set_manager.protocolreferenceparameter': {
            'Meta': {'object_name': 'ProtocolReferenceParameter'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'protocol_reference': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data_set_manager.ProtocolReference']"}),
            'value': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'value_accession': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'value_source': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'value_unit': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'data_set_manager.publication': {
