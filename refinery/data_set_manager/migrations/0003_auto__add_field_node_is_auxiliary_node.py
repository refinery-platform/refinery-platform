...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.is_auxiliary_node'
        db.add_column(u'data_set_manager_node', 'is_auxiliary_node',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.is_auxiliary_node'
        db.delete_column(u'data_set_manager_node', 'is_auxiliary_node')
