...
urlpatterns = patterns('file_server.views',
    ...
    url(r'^profile_viewer/(?P<uuid>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/(?P<sequence_name>[a-zA-Z0-9]+)/(?P<zoom_level>z[0-9])/(?P<start_location>[0-9]+)/(?P<end_location>[0-9]+)/$', 'profile_viewer' ),
)