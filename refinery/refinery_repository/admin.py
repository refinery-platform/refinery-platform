...
from refinery_repository.models import Ontology, StudyDesignDescriptor, StudyFactor, Protocol, Publication, Investigation, StudyAssay, Investigator, Study, StudyBracketedField, RawData, ProcessedData, Assay, DataTransformation, AssayBracketedField
...
class StudyAssayAdmin(admin.ModelAdmin):
    pass
...
admin.site.register(StudyAssay, StudyAssayAdmin)
