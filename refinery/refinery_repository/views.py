...
def cancelled(request):
    ...
    for id in task_ids:
        revoke(id)
    return render_to_response('refinery_repository/cancelled.html', context_instance=RequestContext(request))
...
def results_selected(request):
    ...
    for task_id in task_ids:
        ...
        dictionary['task_id'] = task_id.task_id
...
def download_selected_samples(request):
    ...
    print "task_ids";
    print task_ids;
    request.session['refinery_repository_task_ids_selected'] = task_ids
