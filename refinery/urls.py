...
from core.api import AnalysisResource, ProjectResource, NodeSetResource,\
    ...
    ProjectPermissionResource, DataSetPermissionResource, WorkflowPermissionResource
...
v1_api.register(ProjectPermissionResource())
v1_api.register(DataSetPermissionResource())
v1_api.register(WorkflowPermissionResource())
