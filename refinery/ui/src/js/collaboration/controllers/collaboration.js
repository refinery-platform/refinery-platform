...
collab.controller('refineryCollaborationController', function ($scope, $state, $stateParams, $modal, groupService, groupInviteService, groupMemberService, groupListService) {
  var that = this;
  that.scope = $scope;
  ...
  this.groupList = groupListService.list;

  groupListService.update();
  setTimeout(function () {
    $scope.$digest();
    console.log(that.groupList, groupListService);
  }, 5000);
