(function () {
  ...
  describe('userFile: unit tests', function () {
    var $httpBackend;
    var $rootScope;
    var service;
    var fakeResponse = {
      ...
      nodes: [
        {
          ...
          Year_Characteristics_6_3_s: '1971',
          REFINERY_SUBANALYSIS_6_3_s: '-1',
          Title_Characteristics_6_3_s: 'Format for a Data Stream'
        }, {
          REFINERY_WORKFLOW_OUTPUT_6_3_s: 'N/A',
          REFINERY_ANALYSIS_UUID_6_3_s: 'N/A',
          ...
          Year_Characteristics_6_3_s: '1971',
          REFINERY_SUBANALYSIS_6_3_s: '-1',
          Title_Characteristics_6_3_s: 'Response to RFC 86'
        }, {
          REFINERY_WORKFLOW_OUTPUT_6_3_s: 'N/A',
          REFINERY_ANALYSIS_UUID_6_3_s: 'N/A',
          Author_Characteristics_6_3_s: 'McConnell',
    ...
    beforeEach(function () {
      ...
      inject(function ($injector) {
        ...
        service = $injector.get('userFileService');

        $httpBackend
            .expectGET(
                settings.appRoot +
                settings.refineryApiV2 +
                '/files/?filter_attribute=%7B%7D&limit=100&sort='
