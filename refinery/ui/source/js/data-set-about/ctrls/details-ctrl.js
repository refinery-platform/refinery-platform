/**
 * About Details Ctrl
 * @namespace About Details Ctrl
 * @desc Controller for the majority of text on the data sets about tab.
...
(function () {
  ...
  .controller('AboutDetailsCtrl', AboutDetailsCtrl);

  AboutDetailsCtrl.$inject = [
    '_',
    '$location',
    '$log',
    '$scope',
