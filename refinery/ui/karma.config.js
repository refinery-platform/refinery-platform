...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'bower_components/angular-ui-utils/modules/scroll/scroll.js',
      ...
      'src/js/refinery.js',
      'src/js/commons/router/module.js',
      'src/js/commons/router/*.js',
      'src/js/commons/filter/*.js',
      'src/js/commons/services/*.js',
      'src/js/commons/router/*.js',
      'src/js/**/**/*module.js',
      'src/js/**/*module.js',
      'src/js/**/**/state.js',
      'src/js/**/*state.js',
      'src/js/**/**/*url-router.js',
      'src/js/**/*ctrl.js',
      'src/js/**/*factory.js',
      'src/js/**/*.js',
      'src/js/**/**/*.js',
