...
## [v1.5.2](https://github.com/parklab/refinery-platform/tree/v1.5.2) (2016-11-10)
[Full Changelog](https://github.com/parklab/refinery-platform/compare/v1.5.1...v1.5.2)

**Implemented enhancements:**

- Data Set 2 - Deactivate Selected Filters [\#1508](https://github.com/parklab/refinery-platform/issues/1508)
- IGV should always include gene annotation track [\#1494](https://github.com/parklab/refinery-platform/issues/1494)
- Collaboration Modals [\#1473](https://github.com/parklab/refinery-platform/issues/1473)
- Data Set 2 - Persist UI-Grid Data [\#1446](https://github.com/parklab/refinery-platform/issues/1446)
- Validation of saved sets [\#1342](https://github.com/parklab/refinery-platform/issues/1342)
- Set selector should change on save [\#1341](https://github.com/parklab/refinery-platform/issues/1341)
- Provide two button for quick asignment of files to paired input analyses [\#1019](https://github.com/parklab/refinery-platform/issues/1019)
- Safari Only: IGV Download Opens Blank Tab [\#847](https://github.com/parklab/refinery-platform/issues/847)
- Scrollbar madness after isatab import [\#730](https://github.com/parklab/refinery-platform/issues/730)
- On Dashboard, Analysis list does not update status [\#693](https://github.com/parklab/refinery-platform/issues/693)
- Deleting analyses within the django admin interface should not delete them permanently. [\#480](https://github.com/parklab/refinery-platform/issues/480)
- Update node set sizes after data set update [\#308](https://github.com/parklab/refinery-platform/issues/308)
- create "node detail" view with file download option in sample selection interface [\#243](https://github.com/parklab/refinery-platform/issues/243)
- Jkmarx/data set2 utility deactivate selected [\#1512](https://github.com/parklab/refinery-platform/pull/1512) ([jkmarx](https://github.com/jkmarx))
- Jkmarx/node group refactor [\#1499](https://github.com/parklab/refinery-platform/pull/1499) ([jkmarx](https://github.com/jkmarx))
- Jkmarx/data set2 persist ui grid data [\#1495](https://github.com/parklab/refinery-platform/pull/1495) ([jkmarx](https://github.com/jkmarx))
- Jkmarx/data set2 analyses about refactor [\#1492](https://github.com/parklab/refinery-platform/pull/1492) ([jkmarx](https://github.com/jkmarx))

**Fixed bugs:**

- Data Set 2 Utility/Refresh Bug [\#1506](https://github.com/parklab/refinery-platform/issues/1506)
- Clicking IGV launch buttons is possible without selecting a species [\#1496](https://github.com/parklab/refinery-platform/issues/1496)
- Index files are not created for BAM files generated by RNA-seq workflows [\#1491](https://github.com/parklab/refinery-platform/issues/1491)
- Problem loading remotely located bed file into web-based IGV [\#1487](https://github.com/parklab/refinery-platform/issues/1487)
- Tabular Meta Data File - Cancelation  [\#1475](https://github.com/parklab/refinery-platform/issues/1475)
- Dashboard Filter & Sorting Bug [\#1469](https://github.com/parklab/refinery-platform/issues/1469)
- Dashboard Filter Bug  [\#1468](https://github.com/parklab/refinery-platform/issues/1468)
- Tabular files with a single row don't show up properly in data\_sets 1  file browser [\#1463](https://github.com/parklab/refinery-platform/issues/1463)
- DataSet2 - Analyze Persist Node Group Selection [\#1325](https://github.com/parklab/refinery-platform/issues/1325)
- Filter counts broken between digits [\#1310](https://github.com/parklab/refinery-platform/issues/1310)
- Dashboard workflow loading animation seems to be linked to the data set loading. [\#934](https://github.com/parklab/refinery-platform/issues/934)
- Prov Vis: Button for change layering is not correct after Bootstrap 3 upgrade [\#806](https://github.com/parklab/refinery-platform/issues/806)
- Jkmarx/igv selection bug fix [\#1514](https://github.com/parklab/refinery-platform/pull/1514) ([jkmarx](https://github.com/jkmarx))
- Jkmarx/data set2 utility persist bug [\#1507](https://github.com/parklab/refinery-platform/pull/1507) ([jkmarx](https://github.com/jkmarx))
- Jkmarx/data set2 bug [\#1503](https://github.com/parklab/refinery-platform/pull/1503) ([jkmarx](https://github.com/jkmarx))
- Jkmarx/data set1 attribute filter count bug [\#1501](https://github.com/parklab/refinery-platform/pull/1501) ([jkmarx](https://github.com/jkmarx))
- Jkmarx/data import cancelation bug [\#1500](https://github.com/parklab/refinery-platform/pull/1500) ([jkmarx](https://github.com/jkmarx))
- Jkmarx/prov vis bug [\#1498](https://github.com/parklab/refinery-platform/pull/1498) ([jkmarx](https://github.com/jkmarx))
- Disable igv buttons until species selected. [\#1497](https://github.com/parklab/refinery-platform/pull/1497) ([jkmarx](https://github.com/jkmarx))
- Jkamrx/dashboard filter bug [\#1490](https://github.com/parklab/refinery-platform/pull/1490) ([jkmarx](https://github.com/jkmarx))

**Closed issues:**

- Upgrade Puppet apt module to the latest version [\#774](https://github.com/parklab/refinery-platform/issues/774)
- Update external Javascript packages to the latest stable versions [\#452](https://github.com/parklab/refinery-platform/issues/452)

**Merged pull requests:**

- Add gene annotation track to IGV. Fix \#1494. [\#1516](https://github.com/parklab/refinery-platform/pull/1516) ([mccalluc](https://github.com/mccalluc))
- Scottx611x/resolve manual fake issue [\#1515](https://github.com/parklab/refinery-platform/pull/1515) ([scottx611x](https://github.com/scottx611x))
- This helper script has been moved to its own repo [\#1513](https://github.com/parklab/refinery-platform/pull/1513) ([mccalluc](https://github.com/mccalluc))
- Jkmarx/higlass ui [\#1510](https://github.com/parklab/refinery-platform/pull/1510) ([jkmarx](https://github.com/jkmarx))
- Towards HiGlass UI [\#1509](https://github.com/parklab/refinery-platform/pull/1509) ([mccalluc](https://github.com/mccalluc))
- Hackdna/neo4j repo key error [\#1505](https://github.com/parklab/refinery-platform/pull/1505) ([hackdna](https://github.com/hackdna))
- Fix for tabular metadata uploads that only contain one row [\#1479](https://github.com/parklab/refinery-platform/pull/1479) ([scottx611x](https://github.com/scottx611x))
...
- Remove running Analysis cog animation from LaunchPad filter [\#1476](https://github.com/parklab/refinery-platform/issues/1476)
- Remove unneccessary cog animation. [\#1488](https://github.com/parklab/refinery-platform/pull/1488) ([jkmarx](https://github.com/jkmarx))

**Fixed bugs:**

- Dashboard: Data Cart Selection Bug [\#1471](https://github.com/parklab/refinery-platform/issues/1471)
- tabular meta data file upload failing in Safari 10.0.0 [\#1465](https://github.com/parklab/refinery-platform/issues/1465)
- Tabular Meta Data - Bug when upload fails [\#1458](https://github.com/parklab/refinery-platform/issues/1458)
- Modification Date UI Bug - Test Site [\#1457](https://github.com/parklab/refinery-platform/issues/1457)
- Firefox: "Search" placeholder positioned too low [\#1306](https://github.com/parklab/refinery-platform/issues/1306)
- "datafile" field in FileStoreItem cannot be documented automatically [\#328](https://github.com/parklab/refinery-platform/issues/328)
- Add helper method to exit error div.: [\#1486](https://github.com/parklab/refinery-platform/pull/1486) ([jkmarx](https://github.com/jkmarx))
- Remove add data set method. [\#1485](https://github.com/parklab/refinery-platform/pull/1485) ([jkmarx](https://github.com/jkmarx))
- Specifically set blob api for safari. [\#1482](https://github.com/parklab/refinery-platform/pull/1482) ([jkmarx](https://github.com/jkmarx))

**Closed issues:**

- Adding User to neo4J produces too much travis output [\#1376](https://github.com/parklab/refinery-platform/issues/1376)
- Enable viewing BAM files in IGV [\#1264](https://github.com/parklab/refinery-platform/issues/1264)
- Remove all print statements from Python code [\#1195](https://github.com/parklab/refinery-platform/issues/1195)

**Merged pull requests:**

- Remove all occurrences of `print` currently within our codebase [\#1483](https://github.com/parklab/refinery-platform/pull/1483) ([scottx611x](https://github.com/scottx611x))
- Fix caching bug where \# of Analyses run on a DataSet wasn't updated [\#1481](https://github.com/parklab/refinery-platform/pull/1481) ([scottx611x](https://github.com/scottx611x))
- Fix search text placement to work in Firefox as well [\#1480](https://github.com/parklab/refinery-platform/pull/1480) ([scottx611x](https://github.com/scottx611x))

## [v1.5.0](https://github.com/parklab/refinery-platform/tree/v1.5.0) (2016-10-14)
...
- Tutorial Bug, launching from about page [\#1472](https://github.com/parklab/refinery-platform/issues/1472)
- different species applied to same url not respected [\#1464](https://github.com/parklab/refinery-platform/issues/1464)
...
- provide link to installation notes [\#1462](https://github.com/parklab/refinery-platform/pull/1462) ([mccalluc](https://github.com/mccalluc))
...
- Change layout of the metadata upload page [\#1255](https://github.com/parklab/refinery-platform/issues/1255)
- Problem loading tab delimited metadata file generated as output from R [\#1252](https://github.com/parklab/refinery-platform/issues/1252)
- Node Group API - Current Selection First [\#1244](https://github.com/parklab/refinery-platform/issues/1244)
...
- Analysis Cancel Permission UI  [\#1151](https://github.com/parklab/refinery-platform/issues/1151)
- DataSet2 - Add Fastqc Viewer [\#1047](https://github.com/parklab/refinery-platform/issues/1047)
- DataSet View: Merge Sharing and Details Tab [\#907](https://github.com/parklab/refinery-platform/issues/907)
- Unknown or running analysis page doesn't contain any files [\#893](https://github.com/parklab/refinery-platform/issues/893)
- On AWS, choice of SSH keys is fixed [\#859](https://github.com/parklab/refinery-platform/issues/859)
- Preselect "current selection" for running analyses [\#690](https://github.com/parklab/refinery-platform/issues/690)
- provide option to keep Galaxy history if workflow fails [\#357](https://github.com/parklab/refinery-platform/issues/357)
...
- Data set name is not displayed correctly in the launch pad [\#1242](https://github.com/parklab/refinery-platform/issues/1242)
- Make Django's ALLOWED\_HOSTS work with AWS ELB Health Checks [\#1239](https://github.com/parklab/refinery-platform/issues/1239)
...
- RabbitMQ GPG error during provisioning [\#1181](https://github.com/parklab/refinery-platform/issues/1181)
- Undefined slug should be allowed [\#1166](https://github.com/parklab/refinery-platform/issues/1166)
- Isa archives associated with a DataSet persist after DataSet deletion [\#1158](https://github.com/parklab/refinery-platform/issues/1158)
- Start time is incorrect in analysis result emails [\#1155](https://github.com/parklab/refinery-platform/issues/1155)
- Solr plugin for synonym resolution in wrong location [\#1153](https://github.com/parklab/refinery-platform/issues/1153)
- account activation email needs to be more specific [\#1149](https://github.com/parklab/refinery-platform/issues/1149)
- Solr error when importing ISA archives on AWS [\#1116](https://github.com/parklab/refinery-platform/issues/1116)
- relaunching stack with RDS snapshot fails due to missing host and port in config.json [\#1099](https://github.com/parklab/refinery-platform/issues/1099)
- Downloading input file after its been analyzed yields weird results. [\#1083](https://github.com/parklab/refinery-platform/issues/1083)
- remote data automatically imported into Refinery even when not requested [\#1079](https://github.com/parklab/refinery-platform/issues/1079)
- Add error handling to visualization\_manager.views.get\_file\_name\(\) [\#1058](https://github.com/parklab/refinery-platform/issues/1058)
...
- Change Django settings to production configuration on AWS [\#1208](https://github.com/parklab/refinery-platform/issues/1208)
- DataSet2 - FileStoreItem API Add Field [\#1199](https://github.com/parklab/refinery-platform/issues/1199)
- DataSet2 - FileStoreAPI Display & Services [\#1198](https://github.com/parklab/refinery-platform/issues/1198)
- FileStoreItem API  [\#1192](https://github.com/parklab/refinery-platform/issues/1192)
- Document process of installing Neo4J Ontologies/Annotations from Fritz's Database Backups [\#1159](https://github.com/parklab/refinery-platform/issues/1159)
- Data Set Attribute Filter - CSS Spacing Issue [\#1152](https://github.com/parklab/refinery-platform/issues/1152)
