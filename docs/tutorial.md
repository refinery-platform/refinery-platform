...
![DataSetsHeader](https://github.com/refinery-platform/refinery-platform/blob/develop/docs/screenshots/DataSetsHeader.png)
...
![UploadDataSet](https://github.com/refinery-platform/refinery-platform/blob/develop/docs/screenshots/UploadDataSet.png)
